...
python3 actuator.py --endpoint a2jo5uh3tq8430-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert certs/MQTT_proyecto.cert.pem --key certs/MQTT_proyecto.private.key --client_id basicAlert --topic Hospital1/ --count 0